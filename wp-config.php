 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'AUBgPj3!DOSTbIBiTw`mgJPE;qAr{]J$ `}.Xk*`^74v5x:f,;-hk-Jd9`FuSA;z');
define('SECURE_AUTH_KEY',  'spdn}~RA:)(qcGWJ.W2![N`B^s]1|AZ/s|bjD8fMdT`*x@a?NAxx#~1Q-juU4Usn');
define('LOGGED_IN_KEY',    'oQ4~z6=@um2qzYEmVGIK+7)lFEp*#bNvuz<s@qSN+5X[q[!`e_0i98_ f%sX{$h`');
define('NONCE_KEY',        '>RP :G|PPJsciR,KA*5ul~VSc)F@IF(<pgA0z#A~o>4PX6dxB%rMuD|xILDL>n3@');
